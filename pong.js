...
Pong = {
    ...
    *
    * @param Runner $runner, Object $cfg
    * @return null
    */
    ...
    * Level
    *
    * Calculates difference between scores
    *
    * @param Int $playerNo
    * @return Int
    */
    ...
    */
    Court: {
        ...
        * Draws scores
        *
        * @param Canvas $ctx, Point $scorePlayer1, Point $scorePlayer2
        * @return null
        */
        ...
        * Draws digits
        *
        * @param Canvas $ctx, Int $n, Int $x, Int $y, Int $w, Int $h
        * @return null
        */
    ...
    */
    Paddle: {
        ...
        * setAuto
        *
        * Sets automatic movement
        *
        * @param Boolean $on, Level $level
        * @return null
        */
        ...
        * predict
        *
        * Sets prediction for ai
        *
        * @param Ball $ball, Int $dt
        * @return null
        */
    ...
    */
    Ball: {
        ...
        * Updates ball
        *
        * @param Int $dt, Paddle $leftPaddle, Paddle $rightPaddle
        * @return null
        */
    ...
    */
    Helper: {
        ...
        * Acceleration logic
        *
        * @param Int $x, Int $y, Int $dx, Int $dy, Int $accel, Int $dt
        * @return Object
        */
        ...
        * Interception logic
        *
        * @param Int $x1, Int $y1, $x2, Int $y2, $x3, Int $y3, $x4, Int $y4, Int $d
        * @return Object
        */
        ...
        *
        * @param Ball $ball, Rect $rect, Int $nx, Int $ny
        * @return Object
        */
        ballIntercept: function(ball, rect, nx, ny) {
            ...
            if (!pt) {
                if (ny < 0) {
                    pt = Pong.Helper.intercept(ball.x, ball.y, ball.x + nx, ball.y + ny, rect.left - ball.radius, rect.bottom + ball.radius, rect.right + ball.radius, rect.bottom + ball.radius, "bottom");
                }
                else if (ny > 0) {
